...
public class ReviewSiteRepository {
	...
	private Route routeOne = new Route(1L, "Twinky", "/images/Twinky.JPG", "5.12a", "Steepest route in the Red");
	private Route routeTwo = new Route(2L, "Phantasia", "/images/Phantasia.jpg", "5.12d", "Next to Twinky");
	private Route routeThree = new Route(3L, "Bedtime for Bonzo", "/images/Bedtime.jpg", "5.6 Trad", "Entry level traditional route, for those seeking adventure.");
